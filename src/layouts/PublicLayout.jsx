          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to={PUBLIC_ROUTES.BECOME_HOST} className="text-gray-300 hover:text-white text-sm transition-colors">
                    Become a Host
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to={PUBLIC_ROUTES.FAQ} className="text-gray-300 hover:text-white text-sm transition-colors">
                    FAQ
                  </Link>
                </li>
                <li>
                  <Link to={PUBLIC_ROUTES.TERMS} className="text-gray-300 hover:text-white text-sm transition-colors">
                    Terms & Conditions
                  </Link>
                </li>
                <li>
                  <Link to={PUBLIC_ROUTES.PRIVACY} className="text-gray-300 hover:text-white text-sm transition-colors">
                    Privacy Policy
                  </Link>
                </li>
                <li>
